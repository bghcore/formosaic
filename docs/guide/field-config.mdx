...
See the [field types reference](/guide/field-types) for the full list of 28 keys (21 editable + 6 read-only + `FieldArray`). Summary:
...
| `"ReadOnlyRichText"` | Read-only rich text (sanitized HTML) |
