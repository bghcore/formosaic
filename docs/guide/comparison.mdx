...
- **Contract-tested parity**: All 11 adapters run the same contract + parity test suite (6,145 tests total across the repo). FormEngine.io's adapter parity is not publicly documented.
