...
> **Note:** In v1.1.0, the main form component was renamed from `FormEngine` to `Formosaic` to match the product name. If you are migrating from `@form-eng/*` directly to v1.1.0+, replace `FormEngine` with `Formosaic` in your imports and JSX.
