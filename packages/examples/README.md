...
A 3-step checkout wizard (Shipping, Payment, Review) with the WizardForm component for step navigation and DynamicForm for form state. Shows dropdown dependencies (country -> state), payment method branching (card vs PayPal), and cross-field validation effects.
