...
const StatusDropdown = (props: IFieldProps<IStatusDropdownProps>) => {
  ...
  if (readOnly) {
    return (
      <div
        className="ak-status-dropdown ak-status-dropdown--readonly"
        data-field-type="StatusDropdown"
        data-field-state="readonly"
      >
        {statusColor && (
          <span
            className="ak-status-dropdown__indicator"
  ...
  return (
    ...
    >
      ...
      <select
        className="ak-status-dropdown__select"
