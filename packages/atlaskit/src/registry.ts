...
/** Creates the default Atlassian Design System field registry for use with InjectedFieldProvider */
export function createAtlaskitFieldRegistry(): Dictionary<React.JSX.Element> {
  return {
