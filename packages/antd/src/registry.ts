...
/** Creates the default Ant Design v5 field registry for use with InjectedFieldProvider */
export function createAntdFieldRegistry(): Dictionary<React.JSX.Element> {
  return {
