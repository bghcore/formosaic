# AGENTS.md -- @formosaic/fluent

## Package Purpose

Fluent UI v9 field component implementations for `@formosaic/core`. Provides 22 editable and 6 read-only field types, plus a one-line registry setup via `createFluentFieldRegistry()`.
