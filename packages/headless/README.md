# @bghcore/dynamic-forms-headless

Headless (unstyled) semantic HTML field components for [@bghcore/dynamic-forms-core](https://www.npmjs.com/package/@bghcore/dynamic-forms-core).
...
```bash
npm install @bghcore/dynamic-forms-headless @bghcore/dynamic-forms-core react react-dom react-hook-form
```

## Quick Start

```tsx
import { DynamicForm, RulesEngineProvider, InjectedFieldProvider } from "@bghcore/dynamic-forms-core";
import { createHeadlessFieldRegistry } from "@bghcore/dynamic-forms-headless";

// Optional: import the minimal default styles
import "@bghcore/dynamic-forms-headless/styles.css";
