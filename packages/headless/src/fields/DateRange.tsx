...
const DateRange = (props: IFieldProps<IDateRangeConfig>) => {
  ...
  return (
    <div
      className="df-date-range"
      data-field-type="DateRange"
      data-field-state={getFieldState({ error, required, readOnly })}
      data-testid={GetFieldDataTestId(fieldName, testId)}
    >
      <div className="df-date-range__inputs">
        <div className="df-date-range__from">
          <label htmlFor={`${fieldName}-start`} className="df-date-range__label">
            From
          </label>
          <input
            id={`${fieldName}-start`}
            type="date"
            className="df-date-range__input df-date-range__input--start"
        ...
        <div className="df-date-range__to">
          <label htmlFor={`${fieldName}-end`} className="df-date-range__label">
            To
          </label>
          <input
            id={`${fieldName}-end`}
            type="date"
            className="df-date-range__input df-date-range__input--end"
      ...
      {rangeError && (
        <span className="df-date-range__range-error" role="alert">
          {rangeError}
        </span>
      )}
    </div>
